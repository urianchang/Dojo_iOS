...
class ToDoListTableViewController: UITableViewController, ItemViewControllerDelegate {

    @IBAction func addItemPressed(_ sender: UIBarButtonItem) {
        performSegue(withIdentifier: "showItemSegue", sender: sender)
    }
    ...
    //: For item view controller delegate
